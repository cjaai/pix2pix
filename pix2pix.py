...
def load_examples():
    ...
    #add by ryou
    #shutil.copy(a.input_file, "facades/val")
    #shutil.copy(a.input_file, "facades")

    #call split_image_64(16X7).sh to split input_file  to facades/val
    global  splitStart
    splitStart = time.time()
    print("split Start: " + str(splitStart))

    #add by ryou: split image to small one (256 * 256)
    #status = os.system('.\split_image_64.sh ' + a.input_file) 
    img = cv2.imread(a.input_file)

    for i in range(17):
       for j in range(8):     
         clp = img[(j * 64):(j * 64 + 256), (i * 64):(i * 64 + 256)]
         #name, ext = os.path.splitext(a.input_file)
         #name = os.path.split(a.input_file)[-1] 
    ...
    #print(str(splitStop-splitStart) + "秒")
...
def main():
    ...
    with sv.managed_session() as sess:
        ...
        if a.mode == "test":
            ...
            #add by ryou : merge all small image to one
